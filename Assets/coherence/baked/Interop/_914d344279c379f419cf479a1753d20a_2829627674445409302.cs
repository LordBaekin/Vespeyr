...
namespace Coherence.Generated
{
    ...
    public struct _914d344279c379f419cf479a1753d20a_2829627674445409302 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Forward_32_InputMask;
            Forward_32_InputSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Horizontal_32_InputMask;
            Horizontal_32_InputSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Yaw_32_InputMask;
            Yaw_32_InputSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Float_32_ValueMask;
            Float_32_ValueSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Int_32_ValueMask;
            Int_32_ValueSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Bool_32_ValueMask;
            Bool_32_ValueSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.ForceMask;
            ForceSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.LegMask;
            LegSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Item_32_IDMask;
            Item_32_IDSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.MovingMask;
            MovingSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Item_32_UseMask;
            Item_32_UseSimulationFrame = frame;
            FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Speed_32_MultiplierMask;
            Speed_32_MultiplierSimulationFrame = frame;
        }

        public static unsafe _914d344279c379f419cf479a1753d20a_2829627674445409302 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 39) {
            ...
            var orig = new _914d344279c379f419cf479a1753d20a_2829627674445409302();
        ...
        public System.Single Horizontal_32_Input;
        public static uint Yaw_32_InputMask => 0b00000000000000000000000000000100;
        public AbsoluteSimulationFrame Yaw_32_InputSimulationFrame;
        public System.Single Yaw_32_Input;
        public static uint Float_32_ValueMask => 0b00000000000000000000000000001000;
        public AbsoluteSimulationFrame Float_32_ValueSimulationFrame;
        public System.Single Float_32_Value;
        public static uint Int_32_ValueMask => 0b00000000000000000000000000010000;
        ...
        {
            var other = (_914d344279c379f419cf479a1753d20a_2829627674445409302)data;
        ...
        public static uint Serialize(_914d344279c379f419cf479a1753d20a_2829627674445409302 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Int_32_Value, _Int_32_Value_Min, _Int_32_Value_Max, "_914d344279c379f419cf479a1753d20a_2829627674445409302.Int_32_Value", logger);
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Item_32_ID, _Item_32_ID_Min, _Item_32_ID_Max, "_914d344279c379f419cf479a1753d20a_2829627674445409302.Item_32_ID", logger);
        ...
        public static _914d344279c379f419cf479a1753d20a_2829627674445409302 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _914d344279c379f419cf479a1753d20a_2829627674445409302();
            if (bitStream.ReadMask())
            {

                val.Forward_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Forward_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Horizontal_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Horizontal_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Yaw_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Yaw_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Float_32_Value = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Float_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Int_32_Value = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Int_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Bool_32_Value = bitStream.ReadBool();
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Bool_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Force = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.ForceMask;
            }
            if (bitStream.ReadMask())
            {

                val.Leg = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.LegMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_ID = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Item_32_IDMask;
            }
            if (bitStream.ReadMask())
            {

                val.Moving = bitStream.ReadBool();
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.MovingMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_Use = bitStream.ReadBool();
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Item_32_UseMask;
            }
            if (bitStream.ReadMask())
            {

                val.Speed_32_Multiplier = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _914d344279c379f419cf479a1753d20a_2829627674445409302.Speed_32_MultiplierMask;
            }
        ...
        {
            return $"_914d344279c379f419cf479a1753d20a_2829627674445409302(" +
