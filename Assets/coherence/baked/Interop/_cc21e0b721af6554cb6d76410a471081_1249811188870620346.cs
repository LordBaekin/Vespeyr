...
namespace Coherence.Generated
{
    ...
    public struct _cc21e0b721af6554cb6d76410a471081_1249811188870620346 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Forward_32_InputMask;
            Forward_32_InputSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Horizontal_32_InputMask;
            Horizontal_32_InputSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Yaw_32_InputMask;
            Yaw_32_InputSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Int_32_ValueMask;
            Int_32_ValueSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Float_32_ValueMask;
            Float_32_ValueSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Bool_32_ValueMask;
            Bool_32_ValueSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.ForceMask;
            ForceSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.LegMask;
            LegSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Item_32_IDMask;
            Item_32_IDSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.MovingMask;
            MovingSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Item_32_UseMask;
            Item_32_UseSimulationFrame = frame;
            FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Speed_32_MultiplierMask;
            Speed_32_MultiplierSimulationFrame = frame;
        }

        public static unsafe _cc21e0b721af6554cb6d76410a471081_1249811188870620346 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 39) {
            ...
            var orig = new _cc21e0b721af6554cb6d76410a471081_1249811188870620346();
        ...
        public System.Single Yaw_32_Input;
        public static uint Int_32_ValueMask => 0b00000000000000000000000000001000;
        ...
        {
            var other = (_cc21e0b721af6554cb6d76410a471081_1249811188870620346)data;
        ...
        public static uint Serialize(_cc21e0b721af6554cb6d76410a471081_1249811188870620346 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Int_32_Value, _Int_32_Value_Min, _Int_32_Value_Max, "_cc21e0b721af6554cb6d76410a471081_1249811188870620346.Int_32_Value", logger);
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Item_32_ID, _Item_32_ID_Min, _Item_32_ID_Max, "_cc21e0b721af6554cb6d76410a471081_1249811188870620346.Item_32_ID", logger);
        ...
        public static _cc21e0b721af6554cb6d76410a471081_1249811188870620346 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _cc21e0b721af6554cb6d76410a471081_1249811188870620346();
            if (bitStream.ReadMask())
            {

                val.Forward_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Forward_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Horizontal_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Horizontal_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Yaw_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Yaw_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Int_32_Value = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Int_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Float_32_Value = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Float_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Bool_32_Value = bitStream.ReadBool();
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Bool_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Force = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.ForceMask;
            }
            if (bitStream.ReadMask())
            {

                val.Leg = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.LegMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_ID = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Item_32_IDMask;
            }
            if (bitStream.ReadMask())
            {

                val.Moving = bitStream.ReadBool();
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.MovingMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_Use = bitStream.ReadBool();
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Item_32_UseMask;
            }
            if (bitStream.ReadMask())
            {

                val.Speed_32_Multiplier = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _cc21e0b721af6554cb6d76410a471081_1249811188870620346.Speed_32_MultiplierMask;
            }
        ...
        {
            return $"_cc21e0b721af6554cb6d76410a471081_1249811188870620346(" +
