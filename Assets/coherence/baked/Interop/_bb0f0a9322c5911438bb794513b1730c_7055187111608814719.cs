...
namespace Coherence.Generated
{
    ...
    public struct _bb0f0a9322c5911438bb794513b1730c_7055187111608814719 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Forward_32_InputMask;
            Forward_32_InputSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Horizontal_32_InputMask;
            Horizontal_32_InputSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Yaw_32_InputMask;
            Yaw_32_InputSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Int_32_ValueMask;
            Int_32_ValueSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Float_32_ValueMask;
            Float_32_ValueSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Bool_32_ValueMask;
            Bool_32_ValueSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.ForceMask;
            ForceSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.LegMask;
            LegSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Item_32_IDMask;
            Item_32_IDSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.MovingMask;
            MovingSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Item_32_UseMask;
            Item_32_UseSimulationFrame = frame;
            FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Speed_32_MultiplierMask;
            Speed_32_MultiplierSimulationFrame = frame;
        }

        public static unsafe _bb0f0a9322c5911438bb794513b1730c_7055187111608814719 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 39) {
            ...
            var orig = new _bb0f0a9322c5911438bb794513b1730c_7055187111608814719();
        ...
        {
            var other = (_bb0f0a9322c5911438bb794513b1730c_7055187111608814719)data;
        ...
        public static uint Serialize(_bb0f0a9322c5911438bb794513b1730c_7055187111608814719 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Int_32_Value, _Int_32_Value_Min, _Int_32_Value_Max, "_bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Int_32_Value", logger);
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.Item_32_ID, _Item_32_ID_Min, _Item_32_ID_Max, "_bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Item_32_ID", logger);
        ...
        public static _bb0f0a9322c5911438bb794513b1730c_7055187111608814719 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _bb0f0a9322c5911438bb794513b1730c_7055187111608814719();
            if (bitStream.ReadMask())
            {

                val.Forward_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Forward_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Horizontal_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Horizontal_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Yaw_32_Input = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Yaw_32_InputMask;
            }
            if (bitStream.ReadMask())
            {

                val.Int_32_Value = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Int_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Float_32_Value = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Float_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Bool_32_Value = bitStream.ReadBool();
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Bool_32_ValueMask;
            }
            if (bitStream.ReadMask())
            {

                val.Force = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.ForceMask;
            }
            if (bitStream.ReadMask())
            {

                val.Leg = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.LegMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_ID = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Item_32_IDMask;
            }
            if (bitStream.ReadMask())
            {

                val.Moving = bitStream.ReadBool();
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.MovingMask;
            }
            if (bitStream.ReadMask())
            {

                val.Item_32_Use = bitStream.ReadBool();
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Item_32_UseMask;
            }
            if (bitStream.ReadMask())
            {

                val.Speed_32_Multiplier = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _bb0f0a9322c5911438bb794513b1730c_7055187111608814719.Speed_32_MultiplierMask;
            }
        ...
        {
            return $"_bb0f0a9322c5911438bb794513b1730c_7055187111608814719(" +
